...
#example of creating the class embedding and expending over a batch dimension
batch_size = 32
...
#create an instance of ViT with the number of classes we're working with (pizza, sushi, steak)
...
#setup optimizer to optimize out ViT model parameters using hyperparameters from the ViT paper
optimizer = torch.optim.Adam(params=vit.parameters(),
                             lr=3e-3,# Base LR from Table 3 for ViT-* ImageNet-1k
                             betas=(0.9, 0.999),#default values but also mentioned in the ViT paper section 4.1
                             weight_decay=0.3)

#setup loss func for multi class classification
...
#plot out Vit model's loss curves
...
pretrained_vit_weights = torchvision.models.ViT_B_16_Weights.DEFAULT #dedault means best avaible

#setup ViT model instance with pretarined weights
...
#train the classifier head of the prerained ViT feature extractor model
set_seeds()
